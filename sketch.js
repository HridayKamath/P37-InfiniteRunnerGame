...
function setup() {
 ...
 console.log(trex.x);
  ...
  invisibleGround = createSprite(200, 185, displayWidth, 10);
...
function draw() {
  ...
  text("Score: "+ score, trex.x-380, trex.y-50);
...
function spawnObstacles() {
  ...
  if (frameCount % 100 === 0) {
    ...
    var obstacles = createSprite(trex.x+500, 160, 10, 10);
...
function spawnClouds() {
  ...
  if (frameCount % 80 === 0) {
    ...
    var clouds = createSprite(trex.x+200, rand, 50, 50);
